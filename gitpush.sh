...
echo 'add a remote pseudo for the cimenergy10 repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/cimenergy10
